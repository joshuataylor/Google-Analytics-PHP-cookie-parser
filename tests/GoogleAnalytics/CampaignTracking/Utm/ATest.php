...
class ATest extends \PHPUnit_Framework_TestCase {
    ...
    public function testParse($__utma) {
        ...
        $this->assertEquals(1357877198, $utma->getInitialVisit()->getTimestamp());

        $this->assertEquals(1357877198, $utma->getPreviousVisit()->getTimestamp());

        $this->assertEquals(1357877198, $utma->getCurrentVisit()->getTimestamp());
